            ...
            <div class="communities-section">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo '<span class="community-badge">' . htmlspecialchars($row['name']) . '</span>';
                    }
                } else {
                ...
                if (count($activities) > 0) {
                    foreach ($activities as $activity) {
                        ...
                        if ($activity['type'] === 'post') {
                            // Display post
                            echo '<h4><i class="fas fa-pen"></i> ' . htmlspecialchars($activity['title']) . '</h4>';
                            ...
                            // Display comment
                            echo '<h4><i class="fas fa-comment"></i> Comment on: <a href="view_post.php?id=' . $activity['post_id'] . '">' . htmlspecialchars($activity['post_title']) . '</a></h4>';
